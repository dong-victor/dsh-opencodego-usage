 ...
 * `apiKeyEnv` DEEPSEEK_API_KEY stored through the credentials service), with
 ...
 * @property {string} [apiKeyEnv] Credential reference override (e.g. "DEEPSEEK_API_KEY"). Default: llm-deepseek apiKeyEnv.
